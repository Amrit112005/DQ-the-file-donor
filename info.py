...
# upstream
UPSTREAM_REPO = environ.get('UPSTREAM_REPO', 'https://github.com/Amrit112005/DQ-the-file-donor')
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+bvwDAjUI3tQxNGFl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/rudraraut')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', 0))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Movies_Mail')
